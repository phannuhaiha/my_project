  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: null,
        title: Text("CCBHL", style: TextStyle(color: Colors.black, fontSize: 25),),
                  ...
                  children: <Widget>[
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1000), child: Container(
                        ...
                        child: Center(
                          child: Text("Gương", style: TextStyle(fontSize: 20),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1100), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Bàn", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1200), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Ghế", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1300), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Đèn", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1400), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Tủ", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1400), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Giường", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1400), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Thảm", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                  ],
  ...
  Widget makeItem({image, tag, context}) {
    return Hero(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => Product(image: image, tag: tag,)));
        },
        child: Container(
          height: 250,
